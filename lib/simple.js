...
import gtr from 'translate-google-api'
...
/**
    ...
    */
    ...
    async value(jid, content, footerText, button1, id1, quoted, options) {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: fsizedoc, isForwarded: true }, ...options })
    }},
    /** This Section **/
    send2Button: {
    async value(jid, content, footerText, button1, id1, button2, id2, quoted, options) {
    ...
    async value(jid, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: ephemeral, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: fsizedoc, isForwarded: true }, ...options })
    }},
    /** This Section **/
    /**
     * send Button Loc
    ...
    */
    ...
    async value(jid, buffer, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        ...
        const buttons = [
            { index: 1, urlButton: { displayText: htjava + 'ɢɪᴛʜᴜʙ', url: sgh } },
    ...
    async value(jid, buffer, content, footerText, button1, id1, quoted, options) {
        const buttons = [
            { index: 1, urlButton: { displayText: htjava + 'ɢɪᴛʜᴜʙ', url: sgh } },
            { index: 2, callButton: { displayText: htjava + 'ᴏᴡɴᴇʀ',  phoneNumber: nomorown } },
    ...
    async value(jid, buffer, content, footerText, btn1, id1, options) {
        ...
        conn.sendMessage(jid, key, { ephemeralExpiration: ephemeral, mentions: conn.parseMention(content + footerText), contextInfo: { forwardingScore: fsizedoc, isForwarded: true }, ...options })
    }},
    /** This Section **/
    ...
    async value(jid, buffer, content, footerText, btn1, id1, btn2, id2, quoted, options) {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: ephemeral, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: fsizedoc, isForwarded: true } })
    }},
    /** This Section **/
    ...
    async value(jid, buffer, content, footerText, btn1, id1, btn2, id2, btn3, id3, quoted, options) {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: ephemeral, contextInfo: { forwardingScore: fsizedoc, isForwarded: true, mentions: conn.parseMention(content) } })
    }},
    /**
    * Translate Text 
    * @param {String} code
    ...
    */
    ...
    async value(code, text) {
      return gtr(text, { from: 'id', to: code })
    }},
    /**
     * 
     * @param {String} text 
