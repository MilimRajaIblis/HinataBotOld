...
case 'tiktok2':
	...
	return conn.sendList(m.chat, htki + ' 📺 LIST MESSAGE 🔎 ' + htka, `⚡ Hai ${name} Berikut daftar Menu yg Ada di List...`, author, `☂️ Klik Disini ☂️`, tidl, m)
            break
	...
	return conn.sendList(m.chat, htki + ' 📺 LIST MESSAGE 🔎 ' + htka, `⚡ Hai ${name} Berikut daftar Menu yg Ada di List Group...`, author, `☂️ Klik Disini ☂️`, alldd, m)
            break
	...
	return conn.sendList(m.chat, htki + ' 📺 LIST MESSAGE 🔎 ' + htka, `⚡ Hai ${name} Berikut daftar Menu yg Ada di List Group...`, author, `☂️ Klik Disini ☂️`, linkwa, m)
            break
            case 'emojimix':
